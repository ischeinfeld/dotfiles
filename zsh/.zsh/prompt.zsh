# Name of conda environment displayed if it is set.
# both $CONDA variable are either set or not, and the latter is
#	the one that shows the current env (even though it is called
#	default)
function virtualenv_info {
    [ $CONDA_ENV_PATH ] && echo '('`basename $CONDA_DEFAULT_ENV`') '
}
...
PROMPT='
$%{$reset_color%} ${PR_BOLD_YELLOW}$(current_pwd)%{$reset_color%} $(git_prompt_string)
$(prompt_char) '
